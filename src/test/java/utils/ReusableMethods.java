...
public class ReusableMethods {
    ...
    public static void scrollScreenMethod(int xKoordinati,int yKoordinati,int bekleme,int mXKoordinati,int mYKoordinati,int threadSleep) throws InterruptedException {
        TouchAction action = new TouchAction<>(Driver.getAndroidDriver());
        action.press(PointOption.point(xKoordinati,yKoordinati))
